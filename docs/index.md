...
| ---------------- | ------------ | ------------- |
| `arcane`         |  released    | [arcane versions](https://github.com/qopsc/sysext-bakery/releases/tag/arcane) |
| `bird`           |  released    | [bird versions](https://github.com/flatcar/sysext-bakery/releases/tag/bird) |
| `btop`           |  released    | [btop versions](https://github.com/qopsc/sysext-bakery/releases/tag/btop) |
...
| `eza`            |  released    | [eza versions](https://github.com/qopsc/sysext-bakery/releases/tag/eza) |
...
| `neovim`         |  released    | [neovim versions](https://github.com/qopsc/sysext-bakery/releases/tag/neovim) |
...
| `restic`         |  released    | [restic versions](https://github.com/qopsc/sysext-bakery/releases/tag/restic) |
