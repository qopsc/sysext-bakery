...
- Divergence from `flatcar/main` is **nineteen permanent patches**, plus temporary divergences listed in AGENTS.md (currently: the netbird extension, pending flatcar/sysext-bakery#243). Anything else is drift.
...
- Every other file tracks upstream verbatim — in conflicts, upstream wins outside the nineteen patches.
